...
namespace UnityEngine.UI.Extensions.Examples
{
    public class ScrollingCalendar : MonoBehaviour
    {
        ...
        public void checkAge()
        {
            ...
            if (inputFieldDays.text != "" && inputFieldMonths.text != "" && inputFieldYears.text != "" && int.Parse(inputFieldDays.text) > 0 &&
                int.Parse(inputFieldMonths.text) > 0 && int.Parse(inputFieldYears.text) > 0)
            {
                SetDate();
